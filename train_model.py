...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_folder", type=str, default='e:/data/physionet22')
    parser.add_argument("--model_folder", type=str, default='./model/')
    parser.add_argument("--verbose", type=int, default=1)
    args = parser.parse_args()
    train_challenge_model(args.data_folder, args.model_folder, args.verbose) ### Teams: Implement this function!!!
