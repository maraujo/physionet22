rm -r test_outputs recordings_aux
python train_model.py ../cross-validation-data-1-0-3-mini/$1/train model
python run_model.py model ../cross-validation-data-1-0-3-mini/$1/test test_outputs
python evaluate_model.py ../cross-validation-data-1-0-3-mini/$1/test test_outputs/ model
