...
def train_challenge_model(data_folder, model_folder, verbose):
    ...
    noise_model_new.add(tf.keras.layers.MaxPooling2D((2, 2)))
    noise_model_new.add(tf.keras.layers.Dropout(.2))
    # noise_model_new.add(tf.keras.layers.Conv2D(8, (1, 1), activation='relu'))
    # noise_model_new.add(tf.keras.layers.Conv2D(256, (3, 3), activation='relu'))
    # noise_model_new.add(tf.keras.layers.MaxPooling2D((2, 2)))
    # noise_model_new.add(tf.keras.layers.Conv2D(512, (3, 3), activation='relu'))
    noise_model_new.add(tf.keras.layers.Flatten())
    noise_model_new.add(tf.keras.layers.Dropout(.5))
    noise_model_new.add(tf.keras.layers.Dense(64, activation='relu'))
