...
def train_challenge_model(data_folder, model_folder, verbose):
    ...
    murmur_model_dataset_val = tf.keras.utils.image_dataset_from_directory(val_folder_murmur, label_mode="binary", batch_size=1, seed=42, image_size=MURMUR_IMAGE_SIZE, shuffle=False )
    ...
    murmur_model_dataset_test = tf.keras.utils.image_dataset_from_directory(test_folder_murmur, label_mode="binary", batch_size=1, seed=42, image_size=MURMUR_IMAGE_SIZE, shuffle=False )
...
def get_murmur_model():
    ...
    if ALGORITHM_HPS[IS_MURMUR_MODEL_XCEPTION_lbl]:
        ...
        murmur_model.add(tf.keras.layers.Conv2D(ALGORITHM_HPS[N_MURMUR_CNN_NEURONS_LAYERS_lbl], (3, 3), activation='relu', input_shape=(MURMUR_IMAGE_SIZE[0], MURMUR_IMAGE_SIZE[1], 3)))
